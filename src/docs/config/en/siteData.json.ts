...
const docsSiteData: DocsSiteData = {
  title: "Skillber",
  description:
    "A comprehensive skill-building platform covering IAM & PAM, cyber security and SOC analyst, full stack development, Python, cloud engineering, data science, DevOps, mobile app development, and electronic health records management.",
  navSocials: [
    // {
    //   social: "GitHub",
